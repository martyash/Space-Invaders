...
public class Player implements Moveable, Renderable, Prototype {
    ...
    private Player(Vector2D position, double health, double velocity) {
        this.position = new Vector2D(position.getX(), position.getY()); // Deep copy the position
        this.health = health;
    ...
    public Renderable copy(){
        return new Player(this.position, this.health, this.velocity);
