...
public class Bunker implements GameObject, Renderable, Prototype<Bunker> {
    ...
    private Bunker(Vector2D position, double width, double height, int lives, Image image, BunkerState state) {
...
public Bunker copy() {
    return new Bunker(this.position, this.width, this.height, this.lives, this.image, this.state);
}
